...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    public ResponseEntity<Problem> handleEmailAlreadyUsedException(
        pt.famility.backoffice.service.EmailAlreadyUsedException ex,
    ...
    public ResponseEntity<Problem> handleUsernameAlreadyUsedException(
        pt.famility.backoffice.service.UsernameAlreadyUsedException ex,
        NativeWebRequest request
    ) {
    ...
    public ResponseEntity<Problem> handleInvalidPasswordException(
        pt.famility.backoffice.service.InvalidPasswordException ex,
        NativeWebRequest request
    ) {
     ...
     * @return
     *
     * @deprecated removed as of jhipster 7.9.3
     */
    @Deprecated
    @ExceptionHandler
    ...
    @ExceptionHandler
    public ResponseEntity<Problem> handleFirebaseAuthException(FirebaseAuthException ex, NativeWebRequest request) {
        Problem problem = Problem.builder()
            .withStatus(Status.valueOf(ex.getCause().getMessage()))
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "javax.", "com.", "io.", "de.", "pt.famility.backoffice");
    }

    /**
     * FMLTY-688: logging the stacktrace of client errors.
     * The default implementation does not include the stacktrace if status.is4xxClientError().
     */
    @Override
    public void log(Throwable throwable, Problem problem, NativeWebRequest request, HttpStatus status) {
        if (status.is4xxClientError()) {
            log.warn("Error 4xx: " + status.getReasonPhrase(), throwable);
        } else if (status.is5xxServerError()) {
            log.error("Error 5xx: " + status.getReasonPhrase(), throwable);
        }
    }
}
