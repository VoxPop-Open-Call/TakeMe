...
export * from './finish-registration/finish-registration.component';
export * from './finish-registration/finish-registration.service';
export * from './finish-registration/finish-registration.route';
