...
export class PromoterItineraryRoutingResolveService implements Resolve<IPromoterItinerary | null> {
  constructor(protected service: PromoterItineraryService, protected router: Router) {
  }
